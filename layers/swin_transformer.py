...
class PatchMerging(nn.Module):
    ...
    Args:
        ...
        dim (int): Number of input channels and output channels
        norm_layer (nn.Module, optional): Normalization layer.  Default: nn.LayerNorm
    """
...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.contiguous().view(B, H // self.patch_size, W // self.patch_size, self.embed_dim)
        return x
